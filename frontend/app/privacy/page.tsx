...
export const metadata: Metadata = { title: "Privacy Policy - Zamance" };
  ...
  return (
    <LandingPageShell>
      ...
      <p className="mt-2 text-sm opacity-50">
        This describes what the Zamance software actually stores and processes, generated
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm opacity-70">
        <li>Slack workspace (team) ID, workspace name, and bot access token, when a workspace installs Zamance.</li>
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm opacity-70">
        <li>Payout amounts, in any form. Amounts are encrypted client-side before Zamance's backend ever holds them, and are not logged.</li>
        <li>Message content from channels Zamance is not explicitly invoked in.</li>
        <li>Private keys belonging to your team or its members. Zamance's own signer key is never derived from or shared with your workspace.</li>
      </ul>
      ...
      <p className="mt-3 text-sm opacity-70">
        ...
        function - none of them receive plaintext payout amounts from Zamance.
      </p>

      <h2 className="mt-10 text-lg font-semibold">Retention and deletion</h2>
      <p className="mt-3 text-sm opacity-70">
        Data is retained for as long as your workspace has Zamance installed. Uninstalling
